...
module.exports = {
  ...
  NO_CLUSTER_TIP_DESC: '클러스터는 Petasus Cloud를 실행하는 노드(물리적 또는 가상 머신)의 그룹입니다.',
  // List > Remove Cluster
  RISK_WARNING: '위험 경고',
  REMOVE_CLUSTER_TIP_A: '클러스터가 제거된 후에는 클러스터의 리소스가 자동으로 지워지지 않습니다.',
  REMOVE_CLUSTER_TIP_B: '클러스터가 제거된 후에는 클러스터의 멀티 클러스터 구성 데이터가 자동으로 지워지지 않습니다. Petasus Cloud를 제거하거나 관련 리소스를 삭제하면 사용자 데이터가 손실될 수 있습니다. <a href="https://kubesphere.io/docs/"> 공식 Petasus Cloud 설명서</a>를 참조하여 제거된 클러스터의 멀티 클러스터 구성 데이터를 수동으로 지워야 합니다.',

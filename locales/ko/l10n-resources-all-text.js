...
module.exports = {
  ...
  RESOURCES_PASSWORD_PERIOD_SETTING_DESC: "사용자의 비밀번호가 지난 설정한 기간(일)동안 변경되었는지 확인합니다.",  
  RESOURCES_PASSWORD_PERIOD_SETTING_MAXIMUM_AGE: "Maximum age (일)",
  RESOURCES_PASSWORD_PERIOD_SETTING_MAXIMUM_AGE_TIP: "Maximum age 를 입력해 주세요.",
  RESOURCES_PASSWORD_PERIOD_SETTING_NOTI_DAY: "변경 알림 (일)",
  RESOURCES_PASSWORD_PERIOD_SETTING_NOTI_DAY_TIP: "변경 알림 (일)를 입력해 주세요.",
  RESOURCES_PASSWORD_POLICY_MANAGEMENT: "비밀번호 정책 관리",
  RESOURCES_PASSWORD_POLICY_DESC: "사용자 비밀번호 정책과 교체 주기를 관리합니다.",
  ...
  RESOURCES_PASSWORD_POLICY_SETTING_ERROR_MESSAGE_TIP: "오류 메세지를 입력해 주세요.",
  ...
  RESOURCES_PASSWORD_POLICY_SETTING_SPECIAL_CHARACTER_MIN_COUNT: "특수 문자의 최소 수",
  RESOURCES_PASSWORD_POLICY_SETTING_SYMBOL_CHARACTER_SET: "기호 문자셋",
  RESOURCES_PASSWORD_POLICY_SETTING_SYMBOL_CHARACTER_SET_TIP: "기호 문자셋을 입력해 주세요.",
  RESOURCE_PASSWORD_LETTER: '대문자 {uppercaseCount}개 이상, 소문자 {lowercaseCount}개 이상 포함해야 합니다.',

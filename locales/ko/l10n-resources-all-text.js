...
module.exports = {
  ...
  RESOURCES_KAAS_RESOURCE_USAGE: 'KaaS 사용량',
  RESOURCES_CREATE_KAAS_RESOURCE: 'KaaS 생성',
  ...
  RESOURCES_ELB_NETWORK: 'ELB 네트워크',
  ...
  RESOURCES_EDIT_NETWORK: '네트워크 수정',
  ...
  RESOURCES_DHCP_SERVER_DEPLOY: 'DHCP 서버',
  ...
  RESOURCES_SECURITY_GROUP_NAME: '보안 그룹 이름',
  RESOURCES_SECURITY_GROUP: '보안 그룹',
  RESOURCES_CREATE_SECURITY_GROUP: '보안 그룹 생성',
  RESOURCES_EDIT_SECURITY_GROUP: '보안 그룹 수정',
  RESOURCES_DELETE_SECURITY_GROUP_TIP:
    '보안 그룹 이름 <strong>{resource}</strong> 을 입력하여 이 작업의 위험을 이해하고 있는지 확인합니다.',
  RESOURCES_SELECT_SECURITY_GROUP_TIP: '보안 그룹을 선택해 주세요.',
  RESOURCES_SECURITY_GROUP_DESC:
    '보안 그룹의 상태와 사용현황을 관리 할 수 있습니다.',
  ...
  RESOURCES_ELB_NETWORK_IN_USE: '이미 사용 중인 ELB 네트워크입니다.',
  RESOURCES_ELB_MANAGEMENT: 'ELB 관리',
  RESOURCES_ELB_MANAGEMENT_CONDITION_TIP:
    'ELB 관리는 FLAT + External 네트워크에서만 사용할 수 있습니다.',
  RESOURCES_ELB_TYPE: 'ELB 타입',
  RESOURCES_ELB_IP_POOL_INFORMATION: 'ELB IP POOL 정보',
  RESOURCES_ELB_IP_POOL_EMPTY_DESC: 'ELB IP POOL 정보를 입력해주세요.',
  RESOURCES_ELB_IP_POOL_OVERLAP_DESC:
    'ELB IP POOL은 기존 IP POOL과 겹치면 안됩니다.',
  RESOURCES_GATEWAY_IP_IN_POOL_DESC:
    '게이트웨이 IP는 IP POOL 범위에 포함되면 안됩니다.',
  RESOURCES_GATEWAY_IP_IN_ELB_POOL_DESC:
    '게이트웨이 IP는 ELB IP POOL 범위에 포함되면 안됩니다.',
  RESOURCES_MTU: 'MTU',
  RESOURCES_SELECT: '선택',
  RESOURCES_NOT_SELECTED: '선택 안됨',
  RESOURCES_AUTOMATIC: '자동',
  RESOURCES_NO_IP_CHANGE: 'IP 변경 없음',
  ...
  RESOURCES_COMPUTING_RESOURCE: '컴퓨팅 자원',
  RESOURCES_COMPUTING_RESOURCE_USAGE: '컴퓨팅 자원 사용량',
  ...
  RESOURCES_COMPUTING_KAAS_RESOURCE: '컴퓨팅/KaaS 자원',
  RESOURCES_COMPUTING_KAAS_RESOURCE_MONITORING_DESC:
    '컴퓨팅/KaaS 자원 모니터링 데이터를 볼 수 있습니다.',
  ...
  RESOURCES_VM_INTERFACE_EDIT: '인터페이스 편집',
  ...
  RESOURCES_GPU_STATUS: 'GPU 현황',
  RESOURCES_GPU_USAGE: 'GPU 사용량 추이',
  RESOURCES_GPUCLUSTER_NO_VM_LIST: 'GPU 클러스터에 가상머신이 없습니다.',
  RESOURCES_ALERT_VERTICAL: '알림 (세로)',
  RESOURCES_ALERT_HORIZONTAL: '알림 (가로)',
  ...
  RESOURCES_PASSWORD_PERIOD_SETTING_DESC:
    '사용자의 비밀번호가 지난 설정한 기간(일)동안 변경되었는지 확인합니다.',
  RESOURCES_PASSWORD_PERIOD_SETTING_MAXIMUM_AGE: 'Maximum age (일)',
  RESOURCES_PASSWORD_PERIOD_SETTING_MAXIMUM_AGE_TIP:
    'Maximum age 를 입력해 주세요.',
  RESOURCES_PASSWORD_PERIOD_SETTING_NOTI_DAY: '변경 알림 (일)',
  RESOURCES_PASSWORD_PERIOD_SETTING_NOTI_DAY_TIP:
    '변경 알림 (일)를 입력해 주세요.',
  RESOURCES_PASSWORD_POLICY_MANAGEMENT: '비밀번호 정책 관리',
  RESOURCES_PASSWORD_POLICY_DESC:
    '사용자 비밀번호 정책과 교체 주기를 관리합니다.',
  RESOURCES_PASSWORD_POLICY_SETTING: '정책 설정',
  RESOURCES_PASSWORD_POLICY_SETTING_MIN_LENGTH: '최소 길이',
  RESOURCES_PASSWORD_POLICY_SETTING_MAX_LENGTH: '최대 길이',
  RESOURCES_PASSWORD_POLICY_SETTING_ERROR_MESSAGE: '오류 메세지',
  RESOURCES_PASSWORD_POLICY_SETTING_ERROR_MESSAGE_TIP:
    '오류 메세지를 입력해 주세요.',
  RESOURCES_PASSWORD_POLICY_SETTING_UPPERCASE_MIN_COUNT: '대문자의 최소 개수',
  RESOURCES_PASSWORD_POLICY_SETTING_LOWERCASE_MIN_COUNT: '소문자의 최소 개수',
  RESOURCES_PASSWORD_POLICY_SETTING_NUMBER_MIN_COUNT: '숫자의 최소 수',
  RESOURCES_PASSWORD_POLICY_SETTING_SPECIAL_CHARACTER_MIN_COUNT:
    '특수 문자의 최소 수',
  RESOURCES_PASSWORD_POLICY_SETTING_SYMBOL_CHARACTER_SET: '기호 문자셋',
  RESOURCES_PASSWORD_POLICY_SETTING_SYMBOL_CHARACTER_SET_TIP:
    '기호 문자셋을 입력해 주세요.',
  RESOURCE_PASSWORD_LETTER:
    '대문자 {uppercaseCount}개 이상, 소문자 {lowercaseCount}개 이상 포함해야 합니다.',
  RESOURCE_PASSWORD_NUMBER: '숫자를 {minNum} 이상 포함해야 합니다.',
  RESOURCE_PASSWORD_LENGTH: '최소 {minLength}자 이상 포함되어야 합니다.',
  RESOURCE_NOTICE_INFORMATION: '알림 정보',
  RESOURCE_NOTICE_PASSWORD_CHANGE: '비밀번호 변경 알림',
  RESOURCE_NOTICE_PASSWORD_EXPIRE: '비밀번호가 만료 되엇습니다.',
  RESOURCE_NOTICE_PASSWORD_EXPIRE_DAY_TIP_1:
    '비밀번호 만료일이 {remainday}일 남았습니다.',
  RESOURCE_NOTICE_PASSWORD_EXPIRE_DAY_TIP_2:
    '보안을 위해 비밀번호를 주기적으로 변경해야 합니다',

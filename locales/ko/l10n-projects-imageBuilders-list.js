...
module.exports = {
  ...
  TRIGGER_TOKEN_DESC: 'Petasus Cloud에 대해 클라이언트를 인증하는 데 사용되는 토큰을 설정합니다. Webhook을 통해 Petasus Cloud에서 이미지 빌드를 자동으로 트리거하도록 클라이언트를 설정할 수 있습니다. 토큰에는 대문자, 소문자 및 숫자만 포함될 수 있습니다.',

...
module.exports = {
  // Banner
  SERVICE_TYPES_Q: 'Petasus Cloud에서 지원하는 서비스 유형은 무엇입니까?',
  SERVICE_TYPES_A: 'Petasus Cloud는 스테이트리스 서비스 및 스테이트풀 서비스를 지원합니다. 스테이트리스 서비스의 파드 복제본은 동일한 볼륨을 공유하지만 스테이트풀 서비스의 각 파드 복제본은 독립적인 볼륨을 가집니다.',

...
module.exports = {
  ...
  CLUSTER_KUBESPHERE_SETTINGS_DESC: 'Petasus AI Cloud에 대한 사용자 지정 설정',
  ...
  NODE_INTERNAL_IP_DESC: 'Petasus AI Cloud 클러스터에 있는 노드의 내부 IP 주소를 설정합니다.',
  NODE_INTERNAL_IP_EMPTY_DESC: 'Petasus AI Cloud 클러스터에 있는 노드의 내부 IP 주소를 설정하십시오.',
  ...
  KUBESPHERE_SETTINGS: 'Petasus AI Cloud 설정',

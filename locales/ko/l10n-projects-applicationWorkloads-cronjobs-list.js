...
module.exports = {
  ...
  CRONJOB_CRON_DESC: '크론잡에 대한 스케줄을 설정합니다. Petasus Cloud는 기본적으로 UTC를 사용하며 사용자는 표준 시간대에 따라 일정을 조정해야 합니다. <a href="//en.wikipedia.org/wiki/Cron" target="_blank">자세히 알아보기</a>',

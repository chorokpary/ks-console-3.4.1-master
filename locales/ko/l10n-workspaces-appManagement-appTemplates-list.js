...
module.exports = {
  ...
  APP_TEMPLATE_DESC: 'Petasus Cloud는 애플리케이션에 대한 전체 라이프사이클 관리 기능을 제공합니다. 새 앱 템플릿을 업로드하거나 생성하여 빠르게 테스트할 수 있습니다. 또한 앱을 앱스토어에 게시하여 다른 사용자가 원클릭으로 배포할 수 있습니다.',
  DEVELOP_APP_DESC: 'Helm Chart를 업로드하거나 Petasus Cloud에서 제공하는 리소스 오케스트레이션 도구를 사용하여 앱 템플릿을 작성할 수 있습니다.',

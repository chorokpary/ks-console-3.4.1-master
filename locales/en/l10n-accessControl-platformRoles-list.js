...
module.exports = {
  ...
  ROLE_USERS_MANAGER: 'Manage all users on the Petasus AI Cloud platform.',
  ROLE_WORKSPACES_MANAGER: 'Manage all workspaces on the Petasus AI Cloud platform.',
  ROLE_PLATFORM_ADMIN: 'Manage all resources on the Petasus AI Cloud platform.',
  ...
  PERMISSION_PLATFORM_SETTINGS_MANAGEMENT_DESC: 'View and edit settings of the Petasus AI Cloud platform.',

...
module.exports = {
  ...
  LEARN_MORE_CONTACT_US:
    'For more cloud-native technology empowerment services, please <a class="support-action" href="https://petasuscloud.sktenterprise.com/" target="_blank">Contact Us</a>.',
  // Community Support
  ...
  // KubeSphere Cloud
  KUBESPHERE_CLOUD_CAPTION: 'Petasus AI Cloud',
  KSC_FEATURE_BACKUP: 'Petasus AI Cloud Backup',
  ...
  KSC_FEATURE_INSPECTION: 'Petasus AI Cloud Inspection',
  ...
  KSC_FEATURE_LIGHTWEIGHT: 'Petasus AI Cloud Lite',
  KSC_FEATURE_LIGHTWEIGHT_START_DESC: 'Cluster setup in seconds',
  KSC_FEATURE_LIGHTWEIGHT_KS_DESC: 'Out-of-the-box Petasus AI Cloud cluster',

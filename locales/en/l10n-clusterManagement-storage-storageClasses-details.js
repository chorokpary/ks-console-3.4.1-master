...
module.exports = {
  ...
  STORAGE_CLASS_SET_DEFAULT_DESC: 'After the default storage class is set, the system will create volumes of this class by default if no special requirement is added. Only one default storage class is allowed in a Petasus AI Cloud cluster.',
  ...
  AUTHORIZATION_NOT_SUPPORT: 'The cluster currently does not support this feature. Please upgrade Petasus AI Cloud to v3.3.0 or later, or manually install <a href="https://github.com/kubesphere/storageclass-accessor" target="_blank">storageclass-accessor</a>.',
  OPERATOR_IN: 'In',

...
module.exports = {
  ...
  RESOURCES_IMAGE_WAIT_FOR_FIRST_CONSUMER: 'WaitForFirstConsumer',
  RESOURCES_IMAGE_PVC_BOUND: 'PVC Bound',
  RESOURCES_IMAGE_IMPORT_SCHEDULED: 'ImportScheduled',
  RESOURCES_IMAGE_CLONE_SCHEDULED: 'CloneScheduled',
  RESOURCES_IMAGE_UPLOAD_SCHEDULED: 'UploadScheduled',
  RESOURCES_IMAGE_IMPORT_IN_PROGRESS: 'ImportInProgress',
  RESOURCES_IMAGE_CLONE_IN_PROGRESS: 'CloneInProgress',
  RESOURCES_IMAGE_UPLOAD_IN_PROGRESS: 'UploadInProgress',
  RESOURCES_IMAGE_CSI_CLONE_IN_PROGRESS: 'CSICloneInProgress',
  ...
  RESOURCES_NO_USE_KAAS_RESOURCE: 'No KaaS resources in use.',
  RESOURCES_NO_USE_VM: 'No virtual machines in use.',
  RESOURCES_SIZE: 'Size',

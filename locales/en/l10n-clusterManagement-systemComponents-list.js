...
module.exports = {
  ...
  SERVICE_COMPONENTS_DESC: 'System components are software components in the Petasus AI Cloud system, which provide various functions. You can view the running status of services components on this page.',
  // KubeSphere
  STOPPED: 'Stopped',
  RUNNING_TIME: 'Running time',
  KS_CONSOLE_DESC: 'Provides Petasus AI Cloud console services.',

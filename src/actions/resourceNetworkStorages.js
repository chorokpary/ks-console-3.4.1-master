...
import RegistModal from 'clusters/containers/Resources/components/Modals/NetworkStorages/Regist'
import ModifyModal from 'clusters/containers/Resources/components/Modals/NetworkStorages/Modify'

export default {
  'networkstorages.regist': {
    on({ store, cluster, workspace, namespace, success, devops, ...props }) {
      const modal = Modal.open({
        ...
        title: t('RESOURCES_CREATE_NETWORK_STORAGE'),
        modal: RegistModal,
        store,
        cluster,
        workspace,
  ...
  'networkstorages.edit': {
    on({ store, module, detail, cluster, workspace, namespace, success, devops, ...props }) {
      const modal = Modal.open({
        ...
        title: t('RESOURCES_EDIT_NETWORK_STORAGE'),
        modal: ModifyModal,
        store,
        detail,
        module,
  ...
  'networkstorages.remove': {
    on({
      ...
      const modal = Modal.open({
        ...
        desc: t.html('RESOURCES_DELETE_NETWORK_STORAGE_TIP', {

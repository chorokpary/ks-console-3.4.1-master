...
import RegistModal from 'pages/clusters/containers/Resources/components/Modals/ExternalLoadBalancers/Regist'
import ModifyModal from 'pages/clusters/containers/Resources/components/Modals/ExternalLoadBalancers/Modify'
...
export default {
  'externalLoadBalancer.regist': {
    on({ store, cluster, workspace, namespace, success, devops, ...props }) {
      const modal = Modal.open({
        ...
        title: t('RESOURCES_CREATE_EXTERNAL_LOAD_BALANCER'),
        modal: RegistModal,
        store,
        cluster,
        workspace,
  ...
  'externalLoadBalancer.edit': {
    on({ store, module, detail, cluster, workspace, namespace, success, devops, ...props }) {
      const modal = Modal.open({
        ...
        title: t('RESOURCES_EDIT_EXTERNAL_LOAD_BALANCER'),
        modal: ModifyModal,
        store,
        module,
        cluster,
  ...
  'externalLoadBalancer.remove': {
    on({
      ...
      const modal = Modal.open({       
        ...
        desc: t.html('RESOURCES_DELETE_EXTERNAL_LOAD_BALANCER_TIP', {
  ...
  'externalLoadBalancer.remove.batch': {
    on({ store, cluster, workspace, namespace, success, devops, ...props }) {
      ...
      const modal = Modal.open({
        ...
        desc:
          rowKeys.length === 1
            ? t.html('RESOURCES_DELETE_EXTERNAL_LOAD_BALANCER_TIP', { resource: names })
            : t.html('RESOURCES_DELETE_EXTERNAL_LOAD_BALANCER_TIP', { resource: names }),
        resource: names,
        cluster,
        namespace,
  ...
  'externalLoadBalancer.yaml.view': {

...
export default class AppDeployStore extends Base {
  ...
  getHistoryUrl = (params = {}) =>
    `kapis/cmp.kubesphere.io/v1alpha1/app-manager/v1alpha1/taskhistories`
  getDeployUrl = (params = {}) =>
    `kapis/cmp.kubesphere.io/v1alpha1/app-manager/v1alpha1/tasks`
  ...
  async deploy({ detail, ...params }) {
    ...
    await this.submitting(
      request.post(`${this.getDeployUrl(params)}`, jsonData)
    )
  }
}

...
const ResourceChange = ({ widgetKey, monitorStore, ...props }) => {
  ...
  useEffect(() => {
    ...
    const getData = async () => {
      ...
      const vmData = await vmStore.vmList({
        limit: -1,
        sortBy: 'creation_timestamp',
        ...props,
      })
      const kaasData = await kaasStore.fetchList({
        limit: 1000,
        sortBy: 'timestamp',
        ...props,
      })
          ...
          <>
              ...
              <div className="box type_status">
                <div className="cont_group">
                  ...
                  <div className="number_wrap">
                    <p>
                      <span className="em">{podCnt?.Run}</span>
                    </p>
                  </div>
            ...
            <div className="grid_info style_status box_long">
              <div className="box type_status">
                <div className="cont_group">
                  <h5>
                    <i className="ico-type-container"></i>KaaS
                  </h5>
                  <div className="number_wrap">
                    <p>
                      <span className="em">{kaasCnt}</span>
                    </p>
                  </div>

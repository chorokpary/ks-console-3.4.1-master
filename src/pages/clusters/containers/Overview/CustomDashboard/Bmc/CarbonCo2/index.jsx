...
const CarbonCo2 = ({ x, y, w, h, armCo2, x86Co2, loading }) => {
  {
    /* 1대 평균 기준 95.6 KG  */
  }
    ...
    <>
      ...
      <div className="grid_item">
        <div className="grid_title" style={{ cursor: 'default' }}>
          <label>
            {t('RESOURCES_CARBON_FOOTPRINT')} - {t('RESOURCES_CO2_EMISSIONS')} (
            ...
            <div className="box type_chart">
              <div className="cont4">
                <div className="bar_value">
                  <dl className="rgt">
                    <dt>ARM</dt>
                    <dd>{common.fnAddCommar(arm)} KG</dd>
                  </dl>
                  <dl>
                    <dt>x86</dt>
                    <dd>{common.fnAddCommar(x86)} KG</dd>
                  </dl>
                </div>

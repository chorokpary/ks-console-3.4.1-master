            ...
            <ul className="list_02">
              <li className="li_type_02">
                ...
                <div className="rgt">
                  <div className="value">
                    {serverTotalCount}
                    <span>{t('RESOURCES_DAE')}</span>
                  </div>
                  <dl>
                    <dt>ARM</dt>
                    <dd>{armServerCount}</dd>
                  </dl>
                  <dl>
                    <dt>x86</dt>
                    <dd>{x86ServerCount}</dd>
                  </dl>
                </div>
              </li>
              <li className="li_type_02">
              ...
              <li className="li_type_02">
                ...
                <div className="rgt">
                  <div className="value">
                    {common.fnAddCommar(usePrice)}
                    <span>{t('RESOURCES_WON')}</span>
                  </div>
                  <dl>
                    <dt>ARM</dt>
                    <dd>{common.fnAddCommar(armPrice)}</dd>
                  </dl>
                  <dl>
                    <dt>x86</dt>
                    <dd>{common.fnAddCommar(x86Price)}</dd>
                  </dl>
                </div>
              </li>
            </ul>

...
const Bmc = ({ widgetKey, monitorStore, ...props }) => {
    ...
    const fetchData = async () => {
      if (nodeData.length > 0) {
        ...
        await nodeData.map(async obj => {
          ...
          const power_data = metricData.find(

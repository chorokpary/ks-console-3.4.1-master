...
const CarbonPower = ({ x, y, w, h, armUsage, x86Usage, loading }) => {
  {
    /* 1대 평균 기준 200kwh  */
  }
    ...
    <>
      ...
      <div className="grid_item">
        <div className="grid_title" style={{ cursor: 'default' }}>
          <label>
            {t('RESOURCES_CARBON_FOOTPRINT')} - {t('RESOURCES_POWER_USAGE')} (
            {t('RESOURCES_ONE_TO_AVERAGE')})
          </label>
        </div>
            ...
            <div className="box type_chart">
              <div className="cont4">
                <div className="bar_value">
                  <dl className="rgt">
                    <dt>ARM</dt>
                    <dd>{common.fnAddCommar(arm.toFixed(2))} kWh</dd>
                  </dl>
                  <dl>
                    <dt>x86</dt>
                    <dd>{common.fnAddCommar(x86.toFixed(2))} kWh</dd>
                  </dl>
                </div>
                <div className="bar_chart">
                  ...
                  <div className="graph_wrap">
                    <div className="graph_bar">
                      <div
                        className="bar second animate-bar"
                        style={{ width: x86Bar + '%' }}
                      ></div>
                    </div>
                  </div>

...
const ClusterNode = ({ widgetKey, monitorStore, ...props }) => {
              ...
              <div className="cont_group clusternode">
                <div className="cont1">
                  <div className="number_wrap">
                    <i className="ico-type-clusternode">
                      <span>{t('CONTROL_PLANE')}</span>
                    </i>

                    <p>
                      <span className="em">{data.master.on}</span>/
                      {data.master.total}
                    </p>
                  </div>
                  <div className="number_wrap">
                    ...
                    <p>
                      <span className="em">{data.worker.on}</span>/
                      {data.worker.total}
                    </p>
                  </div>
                </div>

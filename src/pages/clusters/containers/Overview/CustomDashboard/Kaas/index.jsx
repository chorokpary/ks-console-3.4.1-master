...
const Kaas = ({ widgetKey, monitorStore, ...props }) => {
              ...
              <div className="cont_group">
                <div className="cont1">
                  <div className="number_wrap">
                    ...
                    <p>
                      <span className="em">{data.ready}</span> / {data.total}
                    </p>
                  </div>
                </div>
                <div className="cont2">
                  <div className="status_wrap">
                    ...
                    <p className="status running">
                      <span>{t('RESOURCES_CLUSTER_READY')}</span>
                    </p>
                  </div>
                  <div className="status_wrap">
                    <div className="value">{data.notReady}</div>
                    <p className="status waiting">
                      <span>{t('RESOURCES_CLUSTER_NOT_READY')}</span>
                    </p>
                  </div>
                </div>
              </div>

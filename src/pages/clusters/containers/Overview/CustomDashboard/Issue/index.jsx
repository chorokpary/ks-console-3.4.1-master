...
const Issue = ({ widgetKey, monitorStore, ...props }) => {
                  ...
                  <li className="li_type_01" key={idx}>
                    <div className="lft">
                      ...
                      <h6 className="list_title">
                        ...
                        <span>
                          {getLocalTime(obj.activeAt).format('YYYY-MM-DD')}
                        </span>
                      </h6>
                    </div>
                    <div className="type">
                      <span className={`type_${getTypeIcon(obj.labels)}`}>
                        {getType(obj.labels)}
                      </span>
                    </div>
                  </li>

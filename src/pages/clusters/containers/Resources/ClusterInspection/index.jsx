                    ...
                    <div className="grid_wrap cluster">
                        <div className="gridbox_wrap">
                            <div className="grid_item">
                                <div className="grid_title">
                                    <label>
                                        {t('CLUSTER_INSPECTION_CLUSTER_STATUS')}
                                    </label>
                                </div>
                                            ...
                                            <div className="cont2">
                                                <div className="status_wrap">
                                                    <p className="status title">
                                                        <span>
                                                            {t(
                                                                'CLUSTER_INSPECTION_CHECK_ALL_LIST',
                                                            )}
                                                        </span>
                                                    </p>
                                                    <div className="value">
                        ...
                        <div className="gridbox_wrap">
                            <div className="grid_item">
                                <div className="grid_title">
                                    <label>
                                        {t('CLUSTER_INSPECTION_CLUSTER_INFO')}
                                    </label>
                                </div>
                                    ...
                                    <ul className="list_01">
                                        <li className="li_type_01">
                                            <div className="lft">
                                                ...
                                                <h6 className="list_title">
                                                    {t(
                                                        'CLUSTER_INSPECTION_K8S_VERSION',
                                                    )}
                                                </h6>
                                            </div>
                                            <div className="value">
                                        ...
                                        <li className="li_type_01">
                                            <div className="lft">
                                                ...
                                                <h6 className="list_title">
                                                    {t(
                                                        'CLUSTER_INSPECTION_PROJECT_CNT',
                                                    )}
                                                </h6>
                                            </div>
                                            <div className="value">
                                        ...
                                        <li className="li_type_01">
                                            <div className="lft">
                                                ...
                                                <h6 className="list_title">
                                                    {t(
                                                        'CLUSTER_INSPECTION_WORKLOAD_CNT',
                                                    )}
                                                </h6>
                                            </div>
                                            <div className="value">
                                                {clusterInfo?.workloadsCount ||
                                                    0}
                                            </div>
                                        </li>
                                    </ul>

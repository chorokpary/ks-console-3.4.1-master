...
const DetailGpuResource = props => {
        ...
        <MonitorTab
          tabs={[
            ...
            },
            {
              key: 'memory',
              icon: 'memory',
              unit: getSuitableUnit(
                flatten(
                  vmGpuRamData?.map(result => get(result, 'values') || [])
                ),
                'memory'
              ),
            ...
            },
            {
              ...
              unit: getSuitableUnit(
                flatten(
                  vmGpuInboundData?.map(result => get(result, 'values') || [])
                ),
                'bandwidth'
              ),
            ...
            },
            {
              ...
              unit: getSuitableUnit(
                flatten(
                  vmGpuOutboundData?.map(result => get(result, 'values') || [])
                ),
                'bandwidth'
              ),
            ...
            },
            {
              ...
              unit: getSuitableUnit(
                flatten(
                  vmGpuNvlinkData?.map(result => get(result, 'values') || [])
                ),
                'bandwidthBytes'
              ),
  ...
  return <div>{renderResourceStatus()}</div>
}

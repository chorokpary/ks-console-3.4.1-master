...
const ConfigGpuWorkloadType = ({ title, onOk, store, ...props }) => {
  ...
  const workloadOptions = [
    { label: t('RESOURCES_GPU_WORKLOAD_CONTAINER'), value: 'container', description: t('RESOURCES_GPU_WORKLOAD_CONTAINER_DESC'), disabled: store.detail.gpunode.driver_type === 'vgpu' || store.detail.gpunode.driver_type === 'none' },
    ...
    { label: t('RESOURCES_GPU_WORKLOAD_VM_VGPU'), value: 'vm-vgpu', description: t('RESOURCES_GPU_WORKLOAD_VM_VGPU_DESC'), disabled: store.detail.gpunode.driver_type === 'native' || store.detail.gpunode.driver_type === 'none' }
  ];

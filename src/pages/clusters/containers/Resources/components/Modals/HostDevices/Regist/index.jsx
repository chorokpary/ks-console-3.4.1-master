...
const RegistModal = props => {
    ...
    const handleOk = () => {
        ...
        const filterCount = addRowList.filter(el => regexName.test(el.name))
            .length;
                            ...
                            >
                                <Select
                                    ...
                                    options={[
                                        {
                                            label: t(
                                                'RESOURCES_MANUFACTURING_COMPANY_NAME',
                                            ),
                                            value: 1,
                                        },
                                        {
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th>
                                                    <strong>
                                                        {t(
                                                            'RESOURCES_MANUFACTURING_COMPANY_ID',
                                                        )}
                                                    </strong>
                                                </th>
                                                <th>

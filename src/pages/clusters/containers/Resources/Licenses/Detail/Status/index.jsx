...
const StatusPage = props => {
  ...
  const renderStatus = () => {
    const fingerprint_status = {
      name: 'fingerprint',
      flag: validityDetail.fingerprint,
      icon: 'certification',
    }
    const period_status = {
      name: 'period',
      flag: validityDetail.period,
      icon: 'timed-task',
    }
    const node_num_status = {
      name: 'node_num',
      flag: validityDetail.node_num,
      icon: 'nodes',
    }
    const vm_num_status = {
      name: 'vm_num',
      flag: validityDetail.vm_num,
      icon: 'vmware',
    }
    return (
        ...
        <div className={styles.header}>
          {validity === true ? (
            <Text
              ...
              extra={<Status status={validity ? 'success' : 'warning'} />}
            />
          ) : (
            <Text
              className={styles.info}

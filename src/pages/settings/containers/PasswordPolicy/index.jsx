      ...
      <div>
        ...
        <div className={styles.tabsContainer}>
          ...
          >
            <TabPanel
              key={1}
              label={t('RESOURCES_PASSWORD_POLICY')}
              name={'policy'}
            />
            <TabPanel
              key={2}
              label={t('RESOURCES_PASSWORD_PERIOD')}
              name={'period'}
            />
          </Tabs>
        </div>
        <Panel>
          <div className={styles.header}>
            <Text
              ...
              title={
                passwordTab == 'policy'
                  ? t('RESOURCES_PASSWORD_POLICY')
                  : t('RESOURCES_PASSWORD_PERIOD')
              }
              description={
                passwordTab == 'policy'
                  ? t('RESOURCES_PASSWORD_POLICY_DESC')
                  : t('RESOURCES_PASSWORD_PERIOD_DESC')
              }
            />
          </div>
          <div className={styles.content}>
            <Form data={formData} ref={form}>
              <Panel
                title={
                  passwordTab == 'policy'
                    ? t('RESOURCES_PASSWORD_POLICY_SETTING')
                    : t('RESOURCES_PASSWORD_PERIOD_SETTING')
                }
                  ...
                  <>
                    <Columns>
                      <Column>
                        <Form.Item
                          label={t(
                            'RESOURCES_PASSWORD_POLICY_SETTING_MIN_LENGTH'
                          )}
                          rules={[
                            {
                              required: true,
                              message: t('RESOURCES_NUMBER_EMPTY_DESC'),
                            },
                          ]}
                        >
                          <Input
                      ...
                      <Column>
                        <Form.Item
                          label={t(
                            'RESOURCES_PASSWORD_POLICY_SETTING_MAX_LENGTH'
                          )}
                          rules={[
                            {
                              required: true,
                    ...
                    <Columns>
                      <Column>
                        <Form.Item
                          label={t(
                            'RESOURCES_PASSWORD_POLICY_SETTING_UPPERCASE_MIN_COUNT'
                          )}
                          rules={[
                            {
                              required: true,
                        ...
                        >
                          <Input
                            ...
                            onChange={val =>
                              handleChange('uppercaseCount', val)
                            }
                          />
                        </Form.Item>
                      </Column>
                      <Column>
                        <Form.Item
                          label={t(
                            'RESOURCES_PASSWORD_POLICY_SETTING_LOWERCASE_MIN_COUNT'
                          )}
                          rules={[
                            {
                              required: true,
                        ...
                        >
                          <Input
                            ...
                            onChange={val =>
                              handleChange('lowercaseCount', val)
                            }
                          />
                        </Form.Item>
                      </Column>
                    ...
                    <Columns>
                      <Column>
                        <Form.Item
                          label={t(
                            'RESOURCES_PASSWORD_POLICY_SETTING_NUMBER_MIN_COUNT'
                          )}
                          rules={[
                            {
                              required: true,
                      ...
                      <Column>
                        <Form.Item
                          label={t(
                            'RESOURCES_PASSWORD_POLICY_SETTING_SPECIAL_CHARACTER_MIN_COUNT'
                          )}
                          rules={[
                            {
                              required: true,
                    ...
                    <Columns>
                      <Column>
                        <Form.Item
                          label={t(
                            'RESOURCES_PASSWORD_POLICY_SETTING_SYMBOL_CHARACTER_SET'
                          )}
                          rules={[
                            {
                              required: true,
                              message: t(
                                'RESOURCES_PASSWORD_POLICY_SETTING_SYMBOL_CHARACTER_SET_TIP'
                              ),
                            },
                          ]}
                        >
                ...
                {passwordTab == 'period' && (
                  <Columns>
                    <Column>
                      <Form.Item
                        label={t(
                          'RESOURCES_PASSWORD_PERIOD_SETTING_MAXIMUM_AGE'
                        )}
                        rules={[
                          {
                            required: true,
                            message: t(
                              'RESOURCES_PASSWORD_PERIOD_SETTING_MAXIMUM_AGE_TIP'
                            ),
                          },
                          {
                            validator: (_, value) => {
                      ...
                      <div style={{ padding: '5px 0 12px' }}>
                        {t('RESOURCES_PASSWORD_PERIOD_SETTING_DESC')}
                      </div>
                    </Column>
                    <Column>
                      <Form.Item
                        ...
                        rules={[
                          {
                            required: true,
                            message: t(
                              'RESOURCES_PASSWORD_PERIOD_SETTING_NOTI_DAY_TIP'
                            ),
                          },
                          {
                            validator: (_, value) => {
                              ...
                              if (Number(value) > Number(period)) {
                                return Promise.reject(
                                  t('NOTICE_DAY_MUST_BE_LESS_THAN_PERIOD')
                                )
                              }

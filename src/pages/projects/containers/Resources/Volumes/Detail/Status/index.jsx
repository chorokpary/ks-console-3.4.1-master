  ...
  return (
    <>
      ...
      {id && !id?.includes('control-plane') &&
        ...
        <div>
          <DetailVmList type={t('RESOURCES_VOLUME')} variables='id' id={id} {...props.match.params} />
        </div>
      }
      {!id && !id?.includes('control-plane') &&
      ...
      {id && id?.includes('control-plane') &&
        ...
        <div>
          <DetailKaasList type={t('RESOURCES_VOLUME')} variables='name' name={id} {...props.match.params} />
        </div>
      }
    </>
  );

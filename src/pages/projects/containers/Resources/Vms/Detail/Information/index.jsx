  ...
  useEffect(() => {
    ...
    const fnGetHostDevices = async () => {
      const response = await request.get(
        `kapis/edgestack.kubesphere.io/v1alpha1/${path}/edgetron/resources/kubevirt/host_devices`
      )
    ...
    const fnGetMediatedDevices = async () => {
      const response = await request.get(
        `kapis/edgestack.kubesphere.io/v1alpha1/${path}/edgetron/resources/kubevirt/mediated_devices`
      )
